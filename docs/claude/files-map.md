...
| `src/lib/strength/mesocycleItemPayload.ts` | `preserveMesocycleTag(next, prev)` — garde `raw_payload.mesocycle_id` à l'édition d'une séance de mésocycle (invariant revert) — §299 | 23 lignes |
