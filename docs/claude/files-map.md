...
| `src/components/coach/strength/TrainingPlansBrowser.tsx` | UI training_plans (§275.4) : liste de plans génériques + dialog création + éditeur grille num_weeks × 7 jours avec picker session | 792 lignes |
