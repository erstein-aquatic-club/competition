...
*Dernière mise à jour : §266 livré (2026-05-10) — Chantier R1 : fix P0 robustesse (idempotencyKey queue offline, auto-sync ref coach, chrono debounce 500ms, 5× window.confirm → AlertDialog). 695/696 tests pass, tsc clean.*
