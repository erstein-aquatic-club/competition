...
*Dernière mise à jour : §189 chrono setup + §186 pace-v2 rétrospective — refonte non-linéaire du moteur d'allures (`paceCalculatorV2.ts`, `paceData.ts`), zones v2 multi-row, V4 conditionnel, drawer overrides mS, vue cross-coach, branding EAC PDF. 3 migrations 00151/00152/00153 prod. §187 (slider affinement) et §188 (lien objectifs↔allures) designés mais pas livrés. (2026-05-01)*
