...
*Dernière mise à jour : §182 — Rattrapage tests RLS reportés post-audit robustesse : §174 P0 cross-coach (migration 00145) + RPC authz (migration 00146) + fix 5 tests cassés `strength_planning.test.ts`. RLS suite 120/125 → 143/143 (+18 tests, 0 régression) (2026-04-26)*
