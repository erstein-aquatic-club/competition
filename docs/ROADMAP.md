...
*Dernière mise à jour : §189-ext livré — drawer objectif unifié Allures + Progression (toggle `ObjectiveDetailSheet`). §187 (slider affinement) designé mais pas livré. (2026-05-02)*
