...
Dernier § livré : **§223** — Refacto C audit §214 : RPC `get_coach_kpis` Postgres (security invoker). 2-10 round-trips Coach home → 1. -67 LOC sur Coach.tsx + dead code retiré.
